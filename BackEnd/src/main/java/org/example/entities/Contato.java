...
public class Contato implements Serializable {
    ...
    @Column(name = "CON_CELULAR", nullable = false, length = 15)
    private String conCelular;

    @NotBlank(message = "Telefone Comercial é obrigatório")
    @Size(max = 15, message = "Telefone Comercial inválido")
    @Column(name = "CON_TELEFONE_COMERCIAL", nullable = false, length = 15)
